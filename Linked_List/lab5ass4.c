...
void Insert_Beg(st **newnode,st **head)
{
...
void Insert_End(st **newnode,st **head)
{
...
void Insert_At_k(st **newnode,st **head,int p)
{
...
void Search(st **head,int search)
{
...
void Del_At(st **head,int p)
{
    ...
    else
    {
        ...
        *head=(*head)->next;
        ...
        st* del = temp->next; // del pointer points to the node
                          // to be deleted
